...
def lfu_sim(cache_size):
  cache = heap()
  PageFreq = dict() # 얘는 클래스 안에 집어넣기 

  cache_hit = 0
  tot_cnt = 100000
  
  data_file = open("C:/Users/유재림/Desktop/DataStructor-master (1)/DataStructor-master/Data_code/LFU_SIMUL/linkbench_short.trc" , encoding="UTF-8")
